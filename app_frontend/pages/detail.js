          ...
          <div className="max-w-4xl mx-auto py-20 px-4 sm:px-2 lg:px-8 ">
            <div className="flex flex-col md:space-x-20 md:flex-row md:items-center bg-white p-10 shadow-lg">
              ...
              <div className="mt-4 md:mt-0 md:ml-6">
                <h2 className="text-4xl tracking-tight text-gray-800">
                  {title}
                </h2>
                ...
                <div className="mt-8">
                  <button
                    onClick={() => router.back()}
                    className="bg-white hover:text-yellow-600 text-gray-800 py-2 px-4 rounded inline-flex items-center border border-black"
                  >
                    <span>back</span>
