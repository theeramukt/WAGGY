    ...
    <div>
      ...
      {showAlert && (
          <div className="text-center py-4 lg:px-4">
            <div className="p-2 bg-row items-center leading-none lg:rounded-full flex lg:inline-flex" role="alert">
              <span className="flex rounded-full bg-row uppercase px-2 py-1 text-xs font-bold mr-3">New</span>
              <span className="font-semibold mr-2 text-left flex-auto">checking out successfully</span>
