...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-72.5 flex-col overflow-y-hidden bg-row duration-300 ease-linear lg:static lg:translate-x-0 ${
        sidebarOpen ? "translate-x-0" : "-translate-x-full"
      }`}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between mt-3 gap-2 px-12 py-5.5 lg:py-6.5">
        <Link href="/">
          <Image
            width={186}
            height={186}
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="mt-5 px-5 lg:mt-6 lg:px-12">
          {/* <!-- Menu Group --> */}
          <div>
            <h3 className="mb-4 ml-6 text-md font-semibold text-white">MENU</h3>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <ul className="mb-5.5 mt-2 flex flex-col gap-2.5 pl-6">
                <li>
                  <Link href="/dashboard">
                    <button className="bt-dash rounded">
                      Dashboard
                    </button>
                  </Link>
                </li>
